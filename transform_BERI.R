...
path2data = paste0(database, "Biodiversity/BERI/Harwood_Tom_22_May_2024/")
...
out.df = 
  ...
  dplyr::rename(BERI2000_bil = 3, BERI2020_bil = 4, BERI2000_med = 5, BERI2020_med = 6) %>%
...
fwrite(out.df, paste0(path2out ,"BERI_2000_2020_05deg.csv"))
